...
describe('Node Server Request Listener Function', function() {
  ...
  it('Should 200 when OPTIONS request received', function() {
  ...
  it('Should have a message_id property added to messages', function() {
    var stubMsg = {
      username: 'Jono',
      text: 'Do my bidding!'
    };
  ...
  it('Should have a roomname property added to messages', function() {
    var stubMsg = {
      username: 'Jono',
      text: 'Do my bidding!'
    };
